...
#TODO: Refactor this giant test into many smaller, more atomic tests
#TODO: Put test data in inst/testdata
context("Does ensembling work with nested models")
test_that("Does ensembling work with nested models", {
  skip_on_cran()
  ...
  #The below tests ALL depend on ensNest, which means they all MUST be in the
  #Same testthat block
  ensNest <- caretEnsemble(nestedList, iter=2000)
